...
Shader "UI/LinearGradient5"
{
    Properties
    {
        ...
        _ColorPosition2 ("Color Position2", Range(0,1)) = 0.25
        _ColorPosition3 ("Color Position3", Range(0,1)) = 0.5
        _ColorPosition4 ("Color Position4", Range(0,1)) = 0.75
        _ColorPosition5 ("Color Position5", Range(0,1)) = 1

...
Shader "UI/LinearGradient6"
{
    Properties
    {
        ...
        _ColorPosition2 ("Color Position2", Range(0,1)) = 0.2
        _ColorPosition3 ("Color Position3", Range(0,1)) = 0.4
        _ColorPosition4 ("Color Position4", Range(0,1)) = 0.6
        _ColorPosition5 ("Color Position5", Range(0,1)) = 0.8
        _ColorPosition6 ("Color Position6", Range(0,1)) = 1
